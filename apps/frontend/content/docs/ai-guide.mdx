...
2. **IA Mandate**: The `.gemini/rules.md` forces the agent to run this check before finalizing any task.
3. **Registry**: The tool is registered as `Doc-Check` in `.gemini/tools.md`.
